<%@ Page Language="C#" AutoEventWireup="true" CodeFile="原生js div浮动层拖拽锁定代码.aspx.cs" Inherits="Jquery特效_拖动_原生js_div浮动层拖拽锁定代码" %>
...
#box{width:50px;height:50px;background:#fef4eb;padding:0px;margin:50px;border:1px solid #f60;border-radius:25px;background:#f60;}
#box .title{width:50px;height:50px;background:#f60;border-radius:25px;display:block;}
#tool{margin-bottom:10px;}
    #box:hover {width:60px;height:60px;border-radius:30px;
    }
     .title:hover{border-radius:29px;width:59px;height:59px;display:block;
    }
</style>
