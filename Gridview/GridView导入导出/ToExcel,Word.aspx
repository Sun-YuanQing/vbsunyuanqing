<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="ToExcel,Word.aspx.cs" Inherits="_Default" %>
...
<body>
    ...
    <div>
            <table cellpadding="0" cellspacing="0" border="0" width="80%" style="font-size: 11px">
                ...
                <tr><td> <asp:Button ID="Button1" runat="server" Text="导 出 EXCEL 表 格" Height="34px" OnClick="Button1_Click"/><asp:Button ID="Button2" runat="server" Text="导 出 Word 文 档" Height="34px" OnClick="Button2_Click"  /></td>
                 </tr>
            </table>
        </div>
    </form>
