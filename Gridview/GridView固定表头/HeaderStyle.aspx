<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="HeaderStyle.aspx.cs" Inherits="_Default" %>
                ...
                <tr>
                   ...
                   <div style="overflow-y: scroll; height: 200px; width: 300px" id="dvBody">
                        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
                           ...
                           <HeaderStyle   CssClass="fixedheader " Wrap="true"  BackColor="#006699" Font-Bold="True" ForeColor="White"
                             />
