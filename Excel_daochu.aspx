<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Excel_daochu.aspx.vb" Inherits="Excel_daochu" %>
          ...
          <asp:TextBox ID="txb_fjh" runat ="server"  ></asp:TextBox>
            <br />
              <asp:Button ID="btn_ck" runat="server" Text="查 看" OnClick="btn_ck_Click" />
                ...
                <asp:Button ID="btn_fanhui" runat="server" Text="返 回" OnClick="btn_dc_Click" />
            </div></div>
        <div  id ="clear:both" style ="clear :both ;"></div>
